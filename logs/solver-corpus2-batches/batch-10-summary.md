...
Generated: 2026-07-17T11:18:20.782Z
Commit: 44e694f5
...
Workers: 2
Resume: yes (0 level(s) loaded from logs/solver-corpus2-batches/batch-10.checkpoint.jsonl)
Feature filter: (none)
Priority: (none)
Attempt cache: (none)
Levels run: 85
...
- Solved by fallback/legacy path only: 15
- Unsolved: 70
- Hints saved: yes (15 level(s), 15 hint file(s) changed)
...
- Legacy (plain legacy-mode solve): 15
- Unsolved: 70
