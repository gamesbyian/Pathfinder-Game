...
Generated: 2026-07-17T16:15:55.532Z
Commit: d2925101
...
Workers: 2
Resume: yes (0 level(s) loaded from logs/solver-corpus2-batches/batch-20.checkpoint.jsonl)
Feature filter: (none)
Priority: (none)
Attempt cache: (none)
Levels run: 85
...
- Solved by fallback/legacy path only: 14
- Unsolved: 71
- Hints saved: yes (14 level(s), 14 hint file(s) changed)
...
- Legacy (plain legacy-mode solve): 14
- Unsolved: 71
