...
Generated: 2026-07-25T09:51:53.158Z
...
Workers: 4
Resume: yes (0 level(s) loaded from logs/solver-highbudget-sweep/corpus2-batch-185.json.checkpoint.jsonl)
Feature filter: (none)
Priority: (none)
Attempt cache: (none)
Levels run: 6
...
- Unsolved: 3
- Hints saved: yes (3 level(s), 3 hint file(s) changed)
