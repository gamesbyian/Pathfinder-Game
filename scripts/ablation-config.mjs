...
export const FEATURES = {
    ...
    PRUNE_MC_NEIGHBOR_BUDGET:   'production default-ON as of 2026-08-12 (promoted): dynamic must-cross/intersection propagation, revised wiring (excluded from repair\'s seeded-random takePly survivor selection since commit a113d47, retained for DFS/beam and deterministic repair sub-searches). Sound on 97,812 stored-valid paths, 19 oracle-atlas dead branches caught uniquely. 2026-08-11 level-blind full-population A/B (matched flags, no exact-level history): 0 regressions on the published 160-level corpus, 0 on corpus-1 (94/102 both arms), corpus-2 611→665 (+54 net, 59 gained / 5 lost, 7.4:1+ ratio). See reports/2026-08-08-mc-neighbor-budget-propagation.md and docs/solver-opt-in-experiment-ledger.md.',
