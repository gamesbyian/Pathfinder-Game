...
// Workstream 2 remains the active foundation. Naming/documentation work must not silently reorder
// the research queue. Assert the durable priority meaning, not the old heading/list typography.
...
assert.match(
  workstreams,
  /## Current (?:ordered )?execution priority[\s\S]{0,800}?### 1\. Workstream 2\b/u,
  'Workstream 2 must remain item 1 of current execution priority -- naming/research work must not silently reorder the queue',
);
