...
export function decisionContractIssues(contract) {
  ...
  if (population?.researchBlock != null) {
    if (!isNonEmptyString(population?.independentUnit)) issues.push('population.independentUnit');
    if (isNonEmptyString(population?.independentUnit) &&
