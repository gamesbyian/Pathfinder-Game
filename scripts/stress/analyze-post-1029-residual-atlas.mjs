...
import { isDeterministicProductionContextEvidence } from './provenance-source-taxonomy.mjs';
...
const classCounts = {
    ...
    4: { label: 'no T1 winner but a deterministic historical production-context candidate exists', primary: count(r => r.primaryClass === 4), any: count(r => r.classes[4]) },
