 ...
 * fallback, so every flip row this diagnostic ever printed silently reported `profile: undefined`.
 */
...
assert.equal(flip.profile, 'repair', 'flip record must read the current scoringProfileId field, not the removed profileName');
assert.notEqual(flip.profile, undefined);
