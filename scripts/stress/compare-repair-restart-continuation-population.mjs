 ...
 *
 * For each selected level, targets the exact gateKey the census's own early-repair-search attempt used,
...
// Population: census-unsolved levels where a early-repair-search attempt actually ran (repair got a
