...
for (const row of ledger.workflows) {
  ...
  if (row.role === 'evidence-producing') {
    ...
    if (!(source.includes('publish-solver-sweep-result.mjs') || source.includes('sweep-publish.mjs'))) failures.push(`${row.workflow}: evidence workflow lacks standard publisher`);
