...
edit('modules/solver/types.ts', src => {
  ...
  return mustReplace(src, old, replacement, 'PrepLevel cellDenseIndex contract');
});
...
console.log('Removed cellDenseIndex and switched staticNeighborKeys to row-major dense indexing.');
