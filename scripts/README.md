...
- research composition: `research:dossier -- --question-id=<id>` (stable question/premise/MO refs and authored multi-asset joins when available); lower-level `research:relations -- --list [--discover]`; lineage: `research:record-consumption`; integrity: `research:integration-audit`;
