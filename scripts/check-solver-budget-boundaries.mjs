...
const migratedWorkDoseSites = ['coarseStateNearTieRetentionRetryTotalBudget', 'repairFallbackTotalBudget', 'nonDefaultRetryTotalBudget', 'connectivityRetryTotalBudget'];
