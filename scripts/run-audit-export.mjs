...
// Increased to 60m (2026-05-08): solver changes added rescue mechanisms for hard levels
// (L92/L108/L134) that add overhead even when unsuccessful. Revert to 30m once those
// levels are solved or the rescue overhead is further reduced.
// Baseline fallback: 15 * 60 * 1000.
const AUDIT_TIMEOUT_MS = Number(process.env.AUDIT_TIMEOUT_MS || 60 * 60 * 1000);
