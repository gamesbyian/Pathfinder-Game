...
if (process.argv[1] && ['analyze-response-guided-parity-contrast.mjs', 'analyze-response-guided-parity-contrast.bundle.mjs'].includes(path.basename(process.argv[1]))
