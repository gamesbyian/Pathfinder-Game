...
- `forced-work-prevalence-one-shot.yml` — retiring PR #1952 workflow for the corrected post-hard-prune chain-anatomy rerun; delete after result capture.
