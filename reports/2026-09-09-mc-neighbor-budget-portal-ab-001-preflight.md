...
- **Published-corpus regression:** clean. `npm run solver:regression` (production-default config, this flag still opt-in): 160/160 solved, no regressions, `solver-bench --check` PASS.
