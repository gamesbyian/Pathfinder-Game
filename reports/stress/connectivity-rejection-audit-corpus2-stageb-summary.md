...
12905 records in the dominant cluster. 3661 distinct reached-set fingerprints, of which 883 (24.1%) recur across more than one exact state. 3885 distinct normalized boundary-blocker sets, of which 929 (23.9%) recur across more than one exact state.
