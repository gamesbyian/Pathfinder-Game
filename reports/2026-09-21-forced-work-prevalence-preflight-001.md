...
> **Last evidence:** 2026-09-21 — corrected post-hard-prune chain-anatomy rerun `35659746572` (artifact `10666891944`) over the same preregistered 64-parent census.
...
- the first run's chain anatomy is **quarantined** because child identity was reconstructed before final hard pruning; the corrected rerun `35659746572` fixes that identity seam without changing the prevalence/work totals;
- corrected chain anatomy: **4,932,517** chain starts, maximum length **19**, maximum chain work **196**, with median chain length usually 1–2 and p90 usually 2–3.

This is far above the preregistered **HEADROOM POSITIVE** gate. The opportunity is broad rather than a single-family spike. The corrected chain anatomy shows a sea of short forced segments rather than a few giant corridors, so capture-fraction economics should price ordinary one-successor transitions and short runs rather than presuming a long-chain compressor.
