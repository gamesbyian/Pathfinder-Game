...
<!-- research-closeout {"schema":"pathfinder.research-closeout/v1","status":"cancelled","lastEvidenceDate":"2026-09-21","decision":"Do not execute the preregistered 2K/5K connectivity-cut proof-overlap studies because the proof family's downstream-work economics already make the result non-decision-bearing.","remainingGate":"reopen multi-query overlap only for a proof family that first clears soundness, solve-local recurrence and removable-work economics","joins":{"researchQuestion":null,"premiseRefs":[],"measurementOpportunity":null},"evidenceRole":"development","scope":{"populationIdentity":null,"selection":"two preregistered paired-beam connectivity-cut overlap cohorts","inferenceScope":"decision value of executing the planned overlap studies after W1 economics closed"},"claimRefs":[],"sourceArtifacts":["reports/2026-09-21-connectivity-cut-dfs-dominated-work-result-006.md","reports/2026-09-21-computational-work-elimination-paired-proof-overlap-preflight-001.md","reports/2026-09-21-paired-beam-proof-overlap-development-preflight-001.md"],"prospective":{"expectation":"cross-query proof overlap would matter only if the underlying proof had a plausible economic consumer","surprise":"single-query removable-work economics closed before overlap acquisition became necessary","anomaly":null}} -->
