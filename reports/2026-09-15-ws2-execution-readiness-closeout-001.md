...
- Added one plain-Node readiness tool with three modes: Class-4 canary analysis, Class-2 cohort
  ...
  freezes deterministic IDs and complete provenance. The paired analyzer verifies population/config
  identity before reporting participation, gains/losses, target and whole-solve work, downstream
  starvation, censoring, and the advancement/zero-gain decisions.
