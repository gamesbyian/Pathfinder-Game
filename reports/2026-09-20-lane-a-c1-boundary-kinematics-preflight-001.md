...
> **Status:** superseded / concluded by C1 result
...
> **Remaining gate:** none for C1. The reducer ran on 2026-09-20 and concluded mixed + repetition-supported; successor work is C2 global accounting under `reports/2026-09-20-lane-a-c1-boundary-kinematics-result-001.md`.
> **Evidence role:** precommitment

<!-- research-closeout {"schema":"pathfinder.research-closeout/v1","status":"active","lastEvidenceDate":"2026-09-20","decision":"freeze one zero-new-search C1 boundary-kinematics signature over the existing 581 labelled prefixes","remainingGate":"run the frozen reducer against the already-combined exact-label artifact and apply the fixed support/mixing rule","joins":{"researchQuestion":"WS2-SEPARATOR-DYNAMIC-INTERFACE","premiseRefs":[],"measurementOpportunity":null},"evidenceRole":"precommitment","scope":{"populationIdentity":"derived 581-case Lane A C0 population sealed by reports/stress/lane-a-c0-exact-label-projection-2026-09-20.json caseOrderHash","selection":"same 581 cases / 144 C0 cut groups / 98 parent levels as C0; no resampling","inferenceScope":"C1 boundary-kinematics representation sufficiency only"},"claimRefs":[],"sourceArtifacts":["docs/solver-separator-dynamic-interface-contract-preflight.md","reports/2026-09-19-lane-a-c0-signature-collision-result-001.md","scripts/stress/lane-a-c0-population-lib.mjs","scripts/stress/lane-a-boundary-kinematics-lib.mjs","scripts/stress/lane-a-c1-boundary-kinematics-analysis.mjs"],"prospective":{"expectation":"C1 will remove at least some C0 collisions but may remain mixed or fragment strongly","surprise":"C1 becomes pure while retaining substantial repeated-signature support across independent parents","anomaly":"any case/population mismatch, invalid non-portal transition, or correctness/input alarm"}} -->
