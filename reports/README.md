...
[`docs/future-work.md`](../docs/future-work.md) (the live queue),
[`docs/solver-development-roadmap.md`](../docs/solver-development-roadmap.md) (the historical
campaign narrative and reusable workflow), and [`docs/solver-architecture.md`](../docs/solver-architecture.md)
(the durable reference, which folds in verified conclusions), all three of which cite the large
