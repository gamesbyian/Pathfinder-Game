...
> **Last evidence:** 2026-09-19 — the precommitted 600M tier completed (GHA run [35385561798](https://github.com/gamesbyian/Pathfinder-Game/actions/runs/35385561798), 11/20 ids first pass; recovery run [35391933756](https://github.com/gamesbyian/Pathfinder-Game/actions/runs/35391933756) for the 9 ids that hit the shard planner's wall-time-estimate timeout, same recurring pattern documented in the parent report's tier-2 recovery). Builds directly on `reports/2026-09-18-ws2-post-d1-work-ladder-reuse-and-confirmation-preflight-001.md`'s concluded-positive confirmation slice (0/20 solved at 300M nodes, 3/20 at 1.2B nodes, current commit, level-blind).
...
> **Remaining gate:** the full 4x-only matched-work costing against the 390-row residual (see "What this does and does not authorize" below); this report closes only the shape question.
