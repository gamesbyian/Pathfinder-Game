...
**Disposition:** misleading durable name; fix before the #1938/#1939 integration settles.
...
**Disposition:** likely misleading durable name; dedicated consumer census + bounded rename recommended.
...
- N1 should be corrected in the active #1938/#1939 integration before settlement.
- N2 should enter a bounded current-surface rename/census task rather than being opportunistically changed inside unrelated solver research.
