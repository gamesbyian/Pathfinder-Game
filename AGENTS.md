...
| Naming cleanup / rename migration | [`docs/naming-and-vocabulary.md`](docs/naming-and-vocabulary.md), [`docs/naming-cleanup-plan.md`](docs/naming-cleanup-plan.md), [`docs/naming-cleanup-ledger.json`](docs/naming-cleanup-ledger.json), then [`docs/change-recipes.md`](docs/change-recipes.md) and the owning topic doc |
...
| Solver budgets/allocation/determinism | [`docs/solver-optimization-current-queue.md`](docs/solver-optimization-current-queue.md) item #2, then [`docs/solver-budget-determinism.md`](docs/solver-budget-determinism.md), [`docs/solver-scheduling-policy.md`](docs/solver-scheduling-policy.md), and [`docs/architecture-unification-debt.md`](docs/architecture-unification-debt.md) |
