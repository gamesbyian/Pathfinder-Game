...
| Solver research question / acquisition | `research:dossier -- --question-id=<id>`; then `research:acquisition-preflight` if needed; both preserve existing authority and never auto-generate |
