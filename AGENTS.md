...
| Solver optimization/research | [`docs/solver-optimization-current-queue.md`](docs/solver-optimization-current-queue.md), then [`docs/solver-scheduling-policy.md`](docs/solver-scheduling-policy.md), [`docs/solver-technique-operational-taxonomy.md`](docs/solver-technique-operational-taxonomy.md), and [`docs/solver-research-operating-model.md`](docs/solver-research-operating-model.md); current scheduler budget-depth evidence: [`reports/2026-08-23-technique-budget-cap-efficiency.md`](reports/2026-08-23-technique-budget-cap-efficiency.md); architectural speed work: [`docs/solver-architectural-speed-opportunities.md`](docs/solver-architectural-speed-opportunities.md) |
...
4. **Solver priority is the live queue plus explicitly flagged active program docs.** The current **ASAP / HIGH PRIORITY** programs are evidence-driven scheduling/allocation ([`docs/solver-scheduling-policy.md`](docs/solver-scheduling-policy.md), current budget-depth evidence: [`reports/2026-08-23-technique-budget-cap-efficiency.md`](reports/2026-08-23-technique-budget-cap-efficiency.md)) and architectural solver speed ([`docs/solver-architectural-speed-opportunities.md`](docs/solver-architectural-speed-opportunities.md)); operational technique similarity is a scheduler/capability evidence program defined in [`docs/solver-technique-operational-taxonomy.md`](docs/solver-technique-operational-taxonomy.md), not a third production-policy authority. `solver-future-work.md` remains unranked deferred/reopen material and code presence alone does not imply an active hypothesis.
...
Current behavior comes from implementation/topic docs. Solver priority: [`docs/solver-optimization-current-queue.md`](docs/solver-optimization-current-queue.md); active high-priority scheduling program: [`docs/solver-scheduling-policy.md`](docs/solver-scheduling-policy.md) with current budget-depth evidence in [`reports/2026-08-23-technique-budget-cap-efficiency.md`](reports/2026-08-23-technique-budget-cap-efficiency.md); operational technique/config interpretation and the operational-similarity research contract: [`docs/solver-technique-operational-taxonomy.md`](docs/solver-technique-operational-taxonomy.md); active high-priority architectural speed program: [`docs/solver-architectural-speed-opportunities.md`](docs/solver-architectural-speed-opportunities.md); research method: [`docs/solver-research-operating-model.md`](docs/solver-research-operating-model.md); families: [`docs/variant-level-research.md`](docs/variant-level-research.md); default-off mechanisms: [`docs/solver-opt-in-experiment-ledger.md`](docs/solver-opt-in-experiment-ledger.md); deferred ideas: [`docs/solver-future-work.md`](docs/solver-future-work.md). Experiments/history: [`reports/`](reports/README.md) and [`docs/archive/`](docs/archive/README.md).