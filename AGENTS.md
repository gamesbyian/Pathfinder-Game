...
| Solver optimization/research | [`docs/solver-optimization-workstreams.md`](docs/solver-optimization-workstreams.md), then [`docs/solver-research-post-naming-resumption.md`](docs/solver-research-post-naming-resumption.md) for the post-cleanup evidence bridge, then [`docs/solver-research-operating-model.md`](docs/solver-research-operating-model.md) and the relevant specialist doc |
