...
| Solver research question / acquisition | `research:dossier -- --question-id=<id>`; prefer stable question/premise/MO joins and authored multi-asset recipes over lexical inference; then `research:acquisition-preflight` if needed; no authority/auto-generation |
