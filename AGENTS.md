...
| Solver workflow/evidence remediation | [`docs/solver-workflow-evidence-remediation-plan.md`](docs/solver-workflow-evidence-remediation-plan.md), then the workflow/scripts being changed; ordinary solver priority still lives in workstreams |
