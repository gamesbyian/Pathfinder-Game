...
| Existing probe/batch/workflow | [`docs/tooling-catalog.md`](docs/tooling-catalog.md); for a named concept use `node scripts/tooling-census.mjs --compact --query=<term>` before scanning files |
...
4. **Check existing machinery before adding more.** Start with [`docs/tooling-catalog.md`](docs/tooling-catalog.md) and `node scripts/tooling-census.mjs --compact --query=<concept>`; open the full `package.json` or scan script/workflow directories only when the compact lookup is insufficient. [`scripts/README.md`](scripts/README.md) and [`.github/workflows/README.md`](.github/workflows/README.md) are the local/remote maps. Follow naming conventions in [`docs/README.md`](docs/README.md), [`reports/README.md`](reports/README.md), and [`logs/README.md`](logs/README.md).
