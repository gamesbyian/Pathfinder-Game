...
| 14 | former LevelUtils facade -> direct owners / no-reference | **Implemented in Phase 14B; closeout pending.** The facade is deleted; pure/domain, level-data, input-coordinate, and editor-coordinate behavior now has direct owners. |
