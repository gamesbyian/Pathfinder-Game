...
2. `research:relations` composes supplied/bounded-discovered artifacts read-only and exposes active premises/edges plus durable evidence. Historical absence remains unknown; child rows never mint independent support.
