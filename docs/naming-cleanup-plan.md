...
| `modules/solver/archetype.ts` / `archetype.test.ts` | `modules/solver/routing-regime.ts` / `routing-regime.test.ts` | direct file rename; this module now contains routing-regime classification only |
