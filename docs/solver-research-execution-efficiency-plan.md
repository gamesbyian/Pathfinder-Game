...
6. **NEXT:** measure exact dependency-tree reuse on short planner/generator/combine jobs under the now-fixed runtime generation. Long solve shards stay measurement-gated.
7. Do not bulk-optimize helper workflows or long solver shards before their own semantics/economics justify it.
