...
| [`future-work.md`](future-work.md) | Compiled index of genuinely open, non-stale future work, including the current solver queue; use this rather than dated campaign plans to decide what remains undone. The 2026-08-11 queue puts dynamic must-cross resource/interface reasoning first among mechanic-derived leads. |
...
| [`solver-shadow-eval-harness.md`](solver-shadow-eval-harness.md) | Shared shadow-mode evaluation harness for candidate reasoners: probe contract, telemetry, residual decomposition, and the 5,518-branch CP-SAT-labelled atlas. Three original Tier-2 probes are closed as sound but too weak/sparse; the later must-cross neighbor-budget probe crossed the shadow threshold and produced +14 net Corpus-2 solves in a full A/B, but remains opt-in because of 42-gained/28-lost fixed-budget churn. |
...
| [`variant-corpus-solver-research-plan.md`](variant-corpus-solver-research-plan.md) | Active instrumentation plan for mining family boundaries, symmetry invariance, divergence evidence, and family-conditioned winning attempts without changing solver policy; see the current [`2026-08-08 symmetry-sensitivity synthesis`](../reports/2026-08-08-symmetry-orientation-sensitivity-synthesis.md) and ranked next gate |
...
|---|---|
| [`../reports/2026-08-11-dynamic-resource-frontier-synthesis.md`](../reports/2026-08-11-dynamic-resource-frontier-synthesis.md) | Current cross-corpus synthesis: latest failure-property evidence, why static must-cross descriptors/root `freeInt` mostly wash out, why current solver limits should be a moving benchmark frontier rather than editor caps, and the ordered proposals for churn diagnosis, crossing-slack telemetry, conservative portal coverage, joint must-cross compatibility, and turn-family interfaces. |
| [`../reports/2026-08-08-mc-neighbor-budget-propagation.md`](../reports/2026-08-08-mc-neighbor-budget-propagation.md) | Exact derivation and evidence for the sound opt-in must-cross neighbor-budget prune: shadow unique catches, 97,812-path replay, +11/30 pilot, and full 725→739 Corpus-2 A/B with 42 gained / 28 lost. |
...
| [`../reports/2026-08-08-symmetry-orientation-sensitivity-synthesis.md`](../reports/2026-08-08-symmetry-orientation-sensitivity-synthesis.md) | Current orientation/mirroring diagnosis and ranked variant-family gate. Read before adding brute-force rotated/mirrored retries. |
