...
| [`naming-cleanup-phase-records/phase-15-preparation.md`](naming-cleanup-phase-records/phase-15-preparation.md) | Current pre-Phase-15 compatibility-boundary preparation and solver-research handoff requirements; Phase 15 remains pending until implementation begins |
