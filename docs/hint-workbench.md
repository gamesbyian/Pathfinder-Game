...
Only pass `--write-levels` when you intend to append accepted candidates to hint artifacts:
...
After any write-capable run, regenerate and validate derived hint artifacts:
