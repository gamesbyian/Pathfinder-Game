...
> **Progress (2026-06-26):** #1, #3, #5, #6 are complete on branch
> `claude/codebase-quality-review-plan-c8g9fw` (#1/#3/#5 verified on the live GitHub Pages deploy).
> Remaining: #7 (full TS, unblocked by #1; tests are now Vitest-ready to co-migrate); #2 (data
> split, independent); #8 (indirection pruning, optional/last).
