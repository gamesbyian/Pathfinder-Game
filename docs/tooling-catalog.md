...
| Research resolution view | `npm run research:resolution-view -- --in=<analysis.json>[,<analysis.json>...]` | Read-only validated observability/discriminability readiness summary with blocker axes and default remediation classes; consumes specialist envelopes and never infers scientific verdicts |
