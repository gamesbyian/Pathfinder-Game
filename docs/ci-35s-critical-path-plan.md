...
| B1c hint-occurrence import boundary | **measured green / ready to merge** | #2078 ordinary CI: `test:hint-occurrence-acceptance` **15.8 s → 0.1 s**. Hint closeout canary independently reran the full-corpus occurrence acceptance CLI successfully. |
