...
| A2 exact Node 22.23.2 | **full-contract rehearsal in progress** | PR rehearsal runs impact planner, universal fast gate, covered tests, deep proofs, Firestore, and canary under exact Node 22.23.2. Firebase CLI restore uses a separate Node-22 cache generation so Node-20 npx materialization is not reused. |
