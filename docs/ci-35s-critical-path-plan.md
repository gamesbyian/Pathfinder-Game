...
| A4 250k solver canary | **implementation in progress** | Hosted probe 35958399905: original **9/9** fixtures solve in **1.5 s / 1,303,532 nodes** at 250k; same fixture set retained and baseline refreshed from that run. |
