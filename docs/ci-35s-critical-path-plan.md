...
| D1 two-way Node sharding | **final post-hermetic confirmation in progress** | #2091 merged the shared-state repair. Rehearsal reruns the current 204-contract **49.6/49.7 child-s** partition; previous shard walls were 29 s / 24 s and first-start→both-complete 29 s before the race invalidated authority. |
