...
> **Reconciled:** 2026-08-25 after the 976/1700 capability refresh, positive fixed-work repricing A/B, post-976 portfolio exposure rejoin, locked-cohort, beam survivor-selection, reference-model, restart/learned-failure, repair, speed, and corrected lifecycle-attribution evidence.
...
| 2 | Automatic configuration / portfolio construction | **HIGH PRIORITY / RESIDUAL EXPOSURE HEADROOM POSITIVE** | Post-976 rejoin: among 724 current misses, **139** retain an observed unablated singleton census solver; actionability-first classes are **73 not offered**, **57 offered but starved**, **9 offered adequately but no longer replaying**. Of the unoffered set, 23 have a non-IDA isolated solver below 1M nodes; missing cheap beam exposure spans 21 levels. After #0 confirmation resolves, freeze one same-revision fixed-envelope pilot broadening exactly one already-existing cheap beam identity before richer selector machinery or depth tuning. [`post-976 rejoin`](../reports/2026-08-25-post-976-portfolio-exposure-rejoin.md), [`976 reconciliation`](../reports/2026-08-25-capability-sweep-976-reconciliation.md), [`scheduling policy`](solver-scheduling-policy.md) |
...
| 8 | Remaining cheap isolated capability missed by production | **SUBSUMED BY #2/#0; MEASURED** | The post-976 rejoin now quantifies this seam. Keep isolated winners as action/scheduler evidence and feed them into exposure/depth pilots; do not append a permanent tail solely because an isolated winner exists. [`post-976 rejoin`](../reports/2026-08-25-post-976-portfolio-exposure-rejoin.md) |
