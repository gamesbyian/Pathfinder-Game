...
The September 12 freshness reconciliation demonstrated an important provenance caveat: historical technique-census hint capture marked successful experimental cells `isolatedTechnique: true` but did not preserve the source census cell. Exact reconstruction found the suspicious same-revision class-5 rows were **5/5 T1 variants and 0/5 base T1**, all `coarse-state-near-tie-retention-off`. Production already reaches the corresponding retry. Future census provenance should carry cell identity directly so this distinction does not require reconstruction. [`reconciliation`](../reports/2026-09-12-class5-microscope-branch-reconciliation-001.md)
...
`R03229` completed this method on a genuine freshness-cleared class-5 specimen. At the frozen ordinary width-2000 first-loss boundary, depth 22, explicit-prefix CP-SAT found the known culled witness **LIVE** and both the rank-1 retained survivor and width-cutoff survivor **DEAD**. This is B1/B2 recurrence, so the microscope is closed rather than rolled forward to another specimen. Reopen single-level microscope work only for a changed causal question that can produce information beyond another dead-preferred/live-alternative confirmation. [`result`](../reports/2026-09-12-class5-microscope-branch-reconciliation-001.md)
