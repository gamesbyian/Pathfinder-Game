...
- generator- and editor-envelope-specific technique niches before making broad capability claims (the coarse corpus1-vs-corpus2 axis is now answered — corpus1 solves 96.1% overall with 97% of solves from just `main-ladder`+`early-repair-search`, vs. corpus2's 57.4%/78.9% — see [`2026-09-04-corpus1-corpus2-stage-share-comparison-001.md`](../reports/2026-09-04-corpus1-corpus2-stage-share-comparison-001.md); a true generator/editor field remains absent from the census, so finer envelopes than corpus1-vs-corpus2 are still untested. Routing regime specifically was checked as a candidate structural predictor of late-ladder-stage reliance and found **not** predictive (5.07-5.75% across three of four regimes) — see [`2026-09-04-routing-regime-late-stage-reliance-null-001.md`](../reports/2026-09-04-routing-regime-late-stage-reliance-null-001.md)) — but routing regime *does* predict overall multiplicity and production-solved rate (mean `solverCount` 6.40→36.80 and production-solved rate 51.3%→100.0% from `intersection-heavy` to `sparse-low-intersection`, with `multi-portal` a notable exception at similar multiplicity but the lowest solved rate of any regime) — see [`2026-09-04-routing-regime-multiplicity-and-difficulty-001.md`](../reports/2026-09-04-routing-regime-multiplicity-and-difficulty-001.md). Regime composition also differs by corpus (corpus1 has less `intersection-heavy`, more `must-cross-heavy`/`general`), a real partial confound behind corpus1's ease — see [`2026-09-05-routing-regime-composition-by-corpus-001.md`](../reports/2026-09-05-routing-regime-composition-by-corpus-001.md). Corpus1's failure profile also differs qualitatively, not just in rate, from corpus2's: corpus1 produced zero "capped" (ladder-exhausted, raw-node-budget-hit) failures in this run, only ladder-starvation ones, though at n=4 this is thin — see [`2026-09-04-corpus1-starvation-profile-001.md`](../reports/2026-09-04-corpus1-starvation-profile-001.md). The full 17-feature structural risk-factor ranking against production status (not just isolated no-T1-winner status) is now available, led by `constrainedObjects` (standardized diff 1.250) ahead of `portals`/`turnConstraintLoad`/`requiredPathLength` — see [`2026-09-04-production-structural-risk-factors-full-replication-001.md`](../reports/2026-09-04-production-structural-risk-factors-full-replication-001.md); several top entries are collinear (e.g. `constrainedObjects`/`turnConstraintLoad` r=0.78), so read the ranking as a few underlying dimensions, not 17 independent factors — see [`2026-09-05-structural-risk-factor-multicollinearity-001.md`](../reports/2026-09-05-structural-risk-factor-multicollinearity-001.md));
