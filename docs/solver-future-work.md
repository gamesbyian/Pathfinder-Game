...
| Region/AND-OR decomposition engine | C0-C2 compact-interface ladder closed representation-explosive at C2. Reopen only if a different prospectively frozen interface contract restores repeated exact-outcome equivalence without near-unique/full-prefix state. [`result`](../reports/2026-09-20-lane-a-c2-global-accounting-result-001.md) |
