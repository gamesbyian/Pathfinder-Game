...
| **Solution-path/fingerprint selector mining** | Use now only to explain the active cohort. Reopen as a standalone selector program when a compact distinction has a legal pre-search proxy and survives family/temporal holdout. |
