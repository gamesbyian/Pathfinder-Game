...
| 3 | **Card-E continuation / handoff sizing** | **RESOLVED, CLOSED.** A 156-row independent population (5.6x the original 28) confirmed 17/156 (10.9%, CI 6.9-16.8%) reconstructable-but-unexposed, cross-class/regime, clearing the sizing trigger. Neither of two tested mechanism-earned descriptor families beat a depth-controlled baseline; no handoff pilot implemented. [`result`](../reports/2026-09-16-card-e-sizing-and-state-selection-001.md) |
...
| Beam continuation / cross-policy handoff | **CLOSED (2026-09-16), see Card-E row above.** No handoff implemented; reopen only with a new descriptor family. |
