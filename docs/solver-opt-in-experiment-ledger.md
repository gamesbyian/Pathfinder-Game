...
| `STRATEGY_GOAL_ATTRACTION_DISABLED_RETRY_FRESH_WORK_POOL` | **ACTIVE, awaiting population-scale before/after evidence.** New 2026-09-02, directly motivated by the starvation telemetry below: gives the pass a fresh work pool (sized off `diversityBudgetFraction` of `workBudget`) instead of sharing the outer, already-depleting pool. Zero live-play risk (both real interactive callers zero `diversityBudgetFraction`, skipping the whole block). Not yet confirmed at population scale; do not promote without a dedicated before/after A/B measuring real solve movement, not just participation. Implementation details, validation, and why this is opt-in rather than a direct fix: [`../reports/2026-09-02-goal-attraction-disabled-retry-fresh-work-pool-implementation.md`](../reports/2026-09-02-goal-attraction-disabled-retry-fresh-work-pool-implementation.md). Starvation diagnosis: [`../reports/2026-09-02-goal-attraction-disabled-retry-work-pool-starvation.md`](../reports/2026-09-02-goal-attraction-disabled-retry-work-pool-starvation.md). |
