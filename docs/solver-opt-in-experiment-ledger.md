...
| `STRATEGY_REPAIR_LATE_PROBE` | Promoted default-ON 2026-08-20/21. Priority 7's dead-last flat 2M-node repair probe targets levels structurally excluded from ordinary repair routing. Local end-to-end validation found 20 net recoveries from the gate-excluded repair-winner population, referee-valid, with no marginal cost on repair-eligible controls; confirmed at population scale via GHA run 32418694112, Corpus-2 828 -> 868, **+20 gained / 0 lost** (ids R00347/R00373/R00477/R01799/R02097/R02159/R02186/R02259/R02348/R02495/R02573/R02760/R02816/R02884/R03020/R03079/R03119/R03122/R03245/R03252). That dispatch predates the same-day `prep._workCap` staleness fix and the ablated-`repairConfigs` eligibility guard (both bug-hunt fixes landed in PR #1399), but neither could have changed this result: the run used a generous 24h non-binding deadline with a 50,000,000 node cap (nowhere near exhausting the preceding tiers' own headroom) and never combined the flag with an explicit `STRATEGY_REPAIR_FALLBACK: false`. |
