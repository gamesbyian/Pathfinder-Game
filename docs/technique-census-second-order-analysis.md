...
> **Current scheduler use:** queue #1 in [`solver-optimization-current-queue.md`](solver-optimization-current-queue.md) and [`solver-scheduling-policy.md`](solver-scheduling-policy.md).
