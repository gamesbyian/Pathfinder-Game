...
> **Implementation progress (2026-09-19):** complete on PR #1922 after current-head CI, solver-evidence-integrity, and premise-map-hardening validation. Bundles A-F are closed at the scope earned by the evidence; Bundle G was correctly not triggered. Progress updates below are retained execution history, not a second checklist or priority authority.\n> **Post-completion architecture follow-up (2026-09-19):** the consolidation work exposed a small research-domain-model boundary underneath the composition layer. Six repeated correctness-critical semantics have now earned shared owners: canonical semantic identity (`research-semantic-identity-lib.mjs`), population identity/canonicalization (`research-population-identity-lib.mjs`), observation/population-integrity semantics (`research-observation-integrity-lib.mjs`), claim/dependency/reverse-invalidation behavior (`research-claim-lib.mjs`), the common research-question contract (`research-question-contract-lib.mjs`), and the hint/failure evidence applicability lattice (`research-evidence-applicability-lib.mjs`). Specialist payloads, purpose taxonomies and domain-specific outcome classifiers remain separate. Larger candidates (`Study` lifecycle, full population/sample specification, instrument contract, unit topology, production realization) remain deliberately unextracted until a second materially different live producer demonstrates the same invariant. Rationale, near-misses and promotion thresholds are recorded in [`2026-09-19-research-domain-bones-audit-001.md`](../reports/2026-09-19-research-domain-bones-audit-001.md). A second authority-ownership pass then made structured closeouts the machine owner for new report-local disposition in `research-status-index`, made active-execution versus deferred-question reopen service explicit in the derived inventory/integration audit, and confirmed that runtime production realization already has substantial polarity/default-equivalence conformance rather than needing a new registry; see [`2026-09-19-research-authority-ownership-audit-001.md`](../reports/2026-09-19-research-authority-ownership-audit-001.md). A prose-authority follow-up then identified and removed two remaining control-plane prose APIs: default-OFF experiment promotion state and live workstream execution state now have explicit tokens beside their rich human explanations; genuinely open-ended reopen predicates remain prose until a machine consumer earns structure. See [`2026-09-19-research-prose-authority-audit-001.md`](../reports/2026-09-19-research-prose-authority-audit-001.md).
