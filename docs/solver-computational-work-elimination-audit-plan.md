...
- **W1 first candidate:** [development result 002](../reports/2026-09-21-connectivity-cut-certificate-shadow-development-result-002.md) established real portal-free cut-proof recurrence: 650/15,019 confirmed scheduled-call hits, 612 cross-exact-state, 0 false positives. [Selector result 003](../reports/2026-09-21-connectivity-cut-certificate-selector-economics-result-003.md) then found 57.77% repeated exact proof derivations and an 85.48% position-filter scan-reduction upper bound; dedup improved retained coverage to 911 confirmed hits. **Scheduled-call replacement nevertheless stays closed** because even 911 avoided fills are only ~0.0895% of whole-solve canonical work before lookup cost. The earned next falsifier is unscheduled applicability: probe only candidates that survive earlier hard prunes while the production schedule skips connectivity, still with zero prune authority.
...
The next decision-bearing connectivity evidence is now **unscheduled applicability**, not more selector or scheduled-call recurrence: at hard-prune candidates where production deliberately skips connectivity, test only the indexed retained implication after every earlier prune passes. Low incidence closes the family; material multi-parent incidence earns technique-specific downstream-work accounting before any behavioral prune. W2's paired-beam proof-overlap probe and W3's BC1 later-disposition microscope remain independent next measurements.
