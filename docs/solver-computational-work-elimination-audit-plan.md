...
- **W1 first candidate:** portal-free cut reuse has cleared theorem, recurrence, selector, early-applicability and caller-attribution gates, but not yet net economics. [002](../reports/2026-09-21-connectivity-cut-certificate-shadow-development-result-002.md) established 650 confirmed scheduled hits, 612 cross-state, 0 false positives. [003](../reports/2026-09-21-connectivity-cut-certificate-selector-economics-result-003.md) found 57.77% repeated exact proof derivations and an 85.48% position-filter scan-reduction upper bound while closing scheduled-call replacement at ~0.0895% whole-work ceiling. [004](../reports/2026-09-21-connectivity-cut-certificate-unscheduled-applicability-result-004.md) found 49,270 theorem-backed hits where production skipped connectivity. [005](../reports/2026-09-21-connectivity-cut-unscheduled-caller-attribution-result-005.md) assigned 47,389 / 49,270 to ordinary DFS across all 9 positive parents. The active [006 microscope](../reports/2026-09-21-connectivity-cut-dfs-dominated-work-preflight-006.md) measures non-overlapping DFS work beneath outermost proof-hit prefixes. No behavioral prune is authorized yet.
- **W2 preflight:** complete for current retained evidence in [multi-query preflight 001](../reports/2026-09-21-computational-work-elimination-multi-query-preflight-001.md). No shared-search architecture is earned. The first enriched workload is now implemented opt-in on the existing paired 2K/5K beam comparison: isolated searches can report exact portal-free connectivity-cut proof-object overlap alongside exact frontier-prefix overlap, with no shared execution and no cache interpretation.
- **W3 BC1:** routed to the existing `WS2-CUT-BALANCE-PROJECTION` owner. [BC1 removable-work economics seam audit 001](../reports/2026-09-21-bc1-removable-work-economics-seam-audit-001.md) confirms retained frontier-prefix incidence cannot reconstruct saved work and nominates the smallest honest next microscope: a production-inert beam later-disposition shadow using existing BeamResearch lineage/work accounting. No synthetic residual executor or duplicate BC1 queue is earned.
...
- **W4 reusable failed-search output:** source/authority audit complete in [reusable failure-output disposition 001](../reports/2026-09-21-computational-work-elimination-reusable-failure-output-001.md). Search-loss capsules and repair nogoods remain observation/experience rather than proof; joint-obligation is an exact no-storage-customer control; connectivity is the only new candidate currently carrying a proved reusable implication plus a plausible later consumer. No proof store/database is earned.

The next decision-bearing connectivity evidence is now **DFS dominated-work economics**, not more incidence. If outermost proof-hit prefixes account for little executed work, close the family despite tens of thousands of nested hits. If dominated work is material across multiple parents and comfortably exceeds proof-validation cost, a smallest matched-work behavioral DFS prune is earned. W2's paired-beam proof-overlap probe and W3's BC1 later-disposition microscope remain independent next measurements.
