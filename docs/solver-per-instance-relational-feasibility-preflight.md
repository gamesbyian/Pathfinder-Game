...
> **Question 3 result:** the archaeology-flagged gap (commuting-candidate legality was never actually measured) is closed: 12,277 same-obligation-multiset, different-order segment pairs spliced and validated with the native PLAY referee (0 CP-SAT, 0 unknowns) across 25 levels. Length-matched pairs are legal 46.6% of the time (1,453/3,121); every failure is geometric/adjacency or length mismatch, never a lost obligation. Not yet tied to LIVE/DEAD fate. A mechanic-conditioned breakdown found this pooled figure hides a sharp split: **0% legal (2,152/2,152) on any level with a flipping filter present**, vs. 69.9% on portal-only levels and 44.8% on mechanic-free levels -- commutativity is governed by history-dependent mechanics (flippers), not mechanic complexity generally. [`breakdown`](../reports/2026-09-17-lane-d3-mechanic-conditioned-breakdown-result-001.md)
