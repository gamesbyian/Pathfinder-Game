...
1. **Class-3 dose: EVIDENCE GAP.** Historical per-technique dose telemetry does not exist. Reopen on prospective protocol-compatible compact exact-action participation/work evidence. [`result`](../reports/2026-09-17-class3-dose-reconciliation-evidence-gap-001.md)
...
**Execution gate now:** `WS2-WORK-LADDER-ECONOMICS` **closed negative (2026-09-19)**. Before first-loss/rejection/2x2, run bounded [failure-response reconnaissance](solver-failure-evidence-research-integration-plan.md). Two supporting acquisition questions are independently live without changing that main gate: `WS2-ADMISSIBLE-ORDER-RESERVE-STARVATION` is **dispatch-ready** after its one-row R00044 execution-family canary, with a frozen 40-parent 300M default-profile sample and mechanical 0/1/>=2 reducer; `WS2-CLASS3-DOSE-EXPOSURE` has a frozen analysis contract but remains **data-blocked** until the current Class-3 population is regenerated/frozen and a shared-production compact-response producer supplies exact-action dose. A/F3 retain their reopen gates. [`costing`](../reports/2026-09-19-ws2-work-ladder-4x-only-matched-work-costing-result-001.md) · [`reserve preflight`](../reports/2026-09-19-admissible-order-reserve-starvation-prospective-preflight-001.md) · [`Class-3 preflight`](../reports/2026-09-19-class3-exact-action-dose-acquisition-preflight-001.md)
