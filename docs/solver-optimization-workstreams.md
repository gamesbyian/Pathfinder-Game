...
**State:** SUPPORTING / ACTIVE SELECTOR CAPTURE GATE. The pre-winner oracle census found 94.74% of C2 and 87.58% of C1 solved-row canonical attempt work before the eventual winner. The earned next gate is production-inert legal-signal capture at action boundaries; H3 remaining-length allocation remains a separate earned experiment design. [`oracle`](../reports/2026-09-21-prewinner-work-oracle-census-001.md) · [`preflight`](../reports/2026-09-21-action-selection-legal-signal-capture-preflight-001.md)
...
| 1 | Automatic action selection | `supporting` | **LEGAL-SIGNAL CAPTURE ACTIVE** | Build/freeze the action-boundary dataset; test simple legal-signal capture against current/static order with held-out rare-winner protection; no live scheduler change | `WS1-ACTION-SELECTION-LEGAL-SIGNAL-CAPTURE` |
