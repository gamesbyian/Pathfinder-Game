...
**PARALLEL PARITY PREMISES; production unchanged.** Phase-distance + capacity use the shadow probe; `WS2-PARITY-RESPONSE-SIGNATURE` reuses census/hint evidence first. [preflight](solver-parity-phase-capacity-preflight.md) · [audit](../reports/2026-09-19-solver-parity-invariant-audit-001.md).
