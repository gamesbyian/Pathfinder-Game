...
Recent evidence: starvation/capping failure modes, within-corpus multiplicity→production-success, replicated structural-risk signals, and exposure-confounded near-miss identity. The old 35-row production-solved/no-isolated-T1 cohort is now down to one genuinely unresolved ID, `R03195`: direct provenance reinspection shows `R02452` and `R02887` already have current-revision, unguided, unforced standard-repair attempt-0 solves inside the relevant repair work envelope, but those records predate the later `context.isolatedTechnique` marker. See [`../reports/2026-09-05-production-solved-no-isolated-winner-three-residue-followup-001.md`](../reports/2026-09-05-production-solved-no-isolated-winner-three-residue-followup-001.md).

The former clockwise `perimeterSweep` lead is closed as an attribution confound. Production first-success counts favored CW (DFS 21:11; beam 170:76), but the already-existing matched isolated census does not reproduce the effect: beam pairwise wins are CW 104 vs CCW 111 with exclusive solves 53 vs 47, while DFS is 42 vs 50 with exclusives 37 vs 45. Do not seek a generic structural CW selector from the production ratio. Preserve both directions as capability-bearing actions; if directional order/allocation becomes decision-bearing, test it under WS2 with matched exposure/work. See [`../reports/2026-09-05-perimeter-bias-production-attribution-confound-audit-001.md`](../reports/2026-09-05-perimeter-bias-production-attribution-confound-audit-001.md).
