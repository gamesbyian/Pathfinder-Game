...
| 1 | Automatic action selection | **ACTIVE / PARALLEL** | Continue the two stage-3-positive pairs into solution-space mediation; operational first divergence only if cheaper mediators fail. |
