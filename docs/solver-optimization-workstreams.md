...
| 1 | Automatic action selection | `supporting` | `bounded-compute` | **LATE-CONTINUATION SIGNAL / CONFIRMATION NEXT** | Apply the exact frozen 15-signature model unchanged to sample-independent/current production evidence; report capture, winner protection, same-stage/censoring composition and stage concentration before any live continuation treatment | `WS1-ACTION-SELECTION-LEGAL-SIGNAL-CAPTURE` |
