...
**State:** ACTIVE / ECONOMICS CLOSED NEGATIVE; failure-response reconnaissance next; no implementation earned.
...
|---:|---|---|---|---|
| 2 | Residual capability + premise acquisition | **ACTIVE / ECONOMICS CLOSED NEGATIVE** | Failure-response reconnaissance, then smallest justified discriminator; first-loss activates search-loss Phase 9 | `WS2-WORK-LADDER-ECONOMICS` |
