...
2. **Fresh exact LIVE/DEAD sibling asset — ACTIVE NEXT.** The DEAD-core pilot exhausted B2 rather than closing the premise. Harvest a fresh residual-selected, label-blind sibling population; use it first for core size/specificity, then for the census's deferred family-3 measurement and its local-infeasibility-predicts-exact-DEAD test. [`preflight`](solver-fresh-dead-sibling-harvest-preflight.md)
