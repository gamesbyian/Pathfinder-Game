...
|---:|---|---|---|
| 2 | Residual capability + fixed-work allocation | **ACTIVE / FIRST PRIORITY** | Atlas done; portal salvage done/CLOSED NEGATIVE -> bounded admissible-order repricing next, in parallel with the atlas's WS1 menu-expansion candidate. |
