...
**Question-generation pressure:** a production-inert forced-work prevalence probe is prepared to measure the oracle ceiling for post-prune one-successor beam work before any forced-chain implementation is considered. It is a bounded premise-sizing investigation, not a new production queue lane. [`preflight`](../reports/2026-09-21-forced-work-prevalence-preflight-001.md)
