...
**Production boundary:** run `34683011115` is **100/102 C1 + 1,048/1,700 C2**, leaving 652 C2 misses. Corrected atlas (refreshed 2026-09-16 against current `hints-random`; classes 1-3 unchanged): 22 not-offered, 39 offered-but-unreached/starved, 37 exact-dispatched/reached with target-action dose not established by the atlas, 159 no-T1-winner-but-historical-candidate, **395 no known admissible/T1 candidate**. Class 4/5 split drifted from hint-provenance freshening (not a new solve); the actionable 113-row intersection with the closed portal-coarse-merge gain set is unchanged. [`atlas`](../reports/2026-09-12-ws2-post-refresh-residual-atlas-and-capability-memory-census-001.md), [`observability audit`](../reports/2026-09-14-capability-observability-attribution-audit-001.md), [`refresh`](../reports/2026-09-16-class4-residual-atlas-refresh-and-113-freeze-001.md)
...
2. **Class-2 economics:** materialize/freeze the 60-row participant-only cohort, then run matched control/treatment at 7M `late-repair-must-turn-biased-retry`; require target-stage participation, gains/losses, downstream displacement, incremental `workSpent`, wall cost, and symmetric censoring.
