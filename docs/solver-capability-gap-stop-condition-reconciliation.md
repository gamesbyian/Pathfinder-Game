...
| Forced-chain traversal | Historical specialized implementation positive; no current general-search prevalence/economics measurement | premise neither closed nor earned for current solver | POWER / ACTION | How much current canonical work is spent in post-prune one-successor chains, and can certified traversal preserve all transition semantics/work accounting? |
