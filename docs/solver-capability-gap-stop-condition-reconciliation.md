...
| Forced-chain traversal | Historical specialized implementation positive; no current general-search prevalence/economics measurement | premise neither closed nor earned for current solver; production-inert prevalence probe now prepared | POWER / ACTION | Measure the current post-prune one-successor canonical-work ceiling first; only if headroom is material ask what fraction can be safely contracted. [`preflight`](../reports/2026-09-21-forced-work-prevalence-preflight-001.md) |
