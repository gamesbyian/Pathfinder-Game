...
| Forced-chain traversal | Historical specialized implementation positive; no current general-search prevalence/economics measurement | premise neither closed nor earned; probe + frozen 64-parent residual sample prepared | POWER / ACTION | Run the frozen census; only material oracle headroom earns capture-fraction/safety work. [`preflight`](../reports/2026-09-21-forced-work-prevalence-preflight-001.md) |
