...
24. **Calibrate measurement reactivity.** If telemetry can alter search/allocation/work/timing/memory/participation, require parity plus bounded overhead/volume evidence; otherwise treat it as research-only.
