window.THEMES_MORE = {
    lcars: {
        ...
        palette: { bg: '#000000', border: '#ff9900', itemBg: '#000000', itemBorder: '#cc99cc', toolBg: '#000000' },
        headerLeftText: '#000000', headerLeftLabel: 'rgba(0,0,0,0.6)', ghostBg: '#111111', ghostBorder: '#ff9900',
        win: { bg: '#000000', border: '#ff9900', text: '#cc99cc', accent: '#ffcc99' },
        alert: { bg: '#333333', stroke: '#ff9900' },
    ...
    candy_apple: {
        ...
        palette: { bg: '#ffe5e5', border: '#ff0800', itemBg: '#ffffff', itemBorder: '#ff9999', toolBg: '#ffe5e5' },
        headerLeftText: '#ffffff', headerLeftLabel: 'rgba(255,255,255,0.7)', ghostBg: '#ffffff', ghostBorder: '#cc0000',
        win: { bg: '#ffffff', border: '#ff0800', text: '#cc0000', accent: '#800000' },
        alert: { bg: '#cc0000', stroke: '#ffffff' },
    ...
    blonde: {
        ...
        palette: { bg: '#fdfbf7', border: '#d4c271', itemBg: '#ffffff', itemBorder: '#e6dfc8', toolBg: '#fdfbf7' },
        headerLeftText: '#ffffff', headerLeftLabel: 'rgba(255,255,255,0.8)', ghostBg: '#ffffff', ghostBorder: '#d4c271',
        win: { bg: '#ffffff', border: '#d4c271', text: '#b5a452', accent: '#e5d68e' },
        alert: { bg: '#e5d68e', stroke: '#ffffff' },
    ...
    fincher: {
        ...
        palette: { bg: '#0d110e', border: '#354536', itemBg: '#121a15', itemBorder: '#354536', toolBg: '#0d110e' },
        headerLeftText: '#0d110e', headerLeftLabel: 'rgba(13, 17, 14, 0.6)', ghostBg: '#121a15', ghostBorder: '#79875f',
        win: { bg: '#121a15', border: '#79875f', text: '#8c9d6f', accent: '#a34233' },
        alert: { bg: '#1f2b23', stroke: '#8c9d6f' },
        ctrlArea: { bg: '#0d110e', border: '#354536' },
        burst: '#5e6a4b', check: '#0d110e'
    },
    roygbiv: {
        ...
        palette: { bg: '#ffffff', border: '#e2e8f0', itemBg: '#f8f9fa', itemBorder: '#e2e8f0', toolBg: '#ffffff' },
        headerLeftText: '#ffffff', headerLeftLabel: 'rgba(255,255,255,0.8)', ghostBg: '#ffffff', ghostBorder: '#ff0000',
        win: { bg: '#ffffff', border: '#9400d3', text: '#4b0082', accent: '#ff0000' },
        alert: { bg: '#ff0000', stroke: '#ffffff' },
    ...
    so_purple: {
        ...
        palette: { bg: '#2e1065', border: '#581c87', itemBg: '#3b0764', itemBorder: '#581c87', toolBg: '#2e1065' },
        headerLeftText: '#e9d5ff', headerLeftLabel: 'rgba(233, 213, 255, 0.7)', ghostBg: '#3b0764', ghostBorder: '#c084fc',
        win: { bg: '#3b0764', border: '#a855f7', text: '#e9d5ff', accent: '#c084fc' },
        alert: { bg: '#7e22ce', stroke: '#e9d5ff' },
    ...
    denim: {
        ...
        palette: { bg: '#0f172a', border: '#334155', itemBg: '#1e293b', itemBorder: '#334155', toolBg: '#0f172a' },
        headerLeftText: '#ffffff', headerLeftLabel: 'rgba(255,255,255,0.7)', ghostBg: '#1e293b', ghostBorder: '#60a5fa',
        win: { bg: '#1e293b', border: '#3b82f6', text: '#93c5fd', accent: '#60a5fa' },
        alert: { bg: '#1d4ed8', stroke: '#93c5fd' },
    ...
    hello_kitty: {
        ...
        palette: { bg: '#ffffff', border: '#ffb6c1', itemBg: '#fff0f5', itemBorder: '#ffb6c1', toolBg: '#ffffff' },
        headerLeftText: '#ffffff', headerLeftLabel: 'rgba(255,255,255,0.8)', ghostBg: '#fff0f5', ghostBorder: '#ff69b4',
        win: { bg: '#ffffff', border: '#ff69b4', text: '#db7093', accent: '#ff1493' },
        alert: { bg: '#ff69b4', stroke: '#ffffff' },
    ...
    black_tie: {
        ...
        palette: { bg: '#ffffff', border: '#cccccc', itemBg: '#f9f9f9', itemBorder: '#cccccc', toolBg: '#ffffff' },
        headerLeftText: '#ffffff', headerLeftLabel: 'rgba(255,255,255,0.7)', ghostBg: '#ffffff', ghostBorder: '#000000',
        win: { bg: '#ffffff', border: '#000000', text: '#333333', accent: '#222222' },
        alert: { bg: '#000000', stroke: '#ffffff' },
        ctrlArea: { bg: '#ffffff', border: '#cccccc' },
        burst: '#e0e0e0', check: '#000000'
    },
    vegas: {
        ...
        palette: { bg: '#0b001a', border: '#3d1c5e', itemBg: '#1a0b2e', itemBorder: '#3d1c5e', toolBg: '#0b001a' },
        headerLeftText: '#ffffff', headerLeftLabel: 'rgba(255,255,255,0.7)', ghostBg: '#1a0b2e', ghostBorder: '#00f3ff',
        win: { bg: '#1a0b2e', border: '#ff007f', text: '#00f3ff', accent: '#39ff14' },
        alert: { bg: '#5e00ff', stroke: '#00f3ff' },
    ...
    sherbet: {
        ...
        palette: { bg: '#fff0f5', border: '#ffb3c6', itemBg: '#ffffff', itemBorder: '#ffb3c6', toolBg: '#fff0f5' },
        headerLeftText: '#ffffff', headerLeftLabel: 'rgba(255,255,255,0.8)', ghostBg: '#ffffff', ghostBorder: '#ff4d6d',
        win: { bg: '#ffffff', border: '#ff4d6d', text: '#d92550', accent: '#ff7b00' },
        alert: { bg: '#ff4d6d', stroke: '#ffffff' },
    ...
    chrome: {
        ...
        palette: { bg: '#d9dce5', border: '#b0b7c6', itemBg: '#e6e8fa', itemBorder: '#b0b7c6', toolBg: '#d9dce5' },
        headerLeftText: '#ffffff', headerLeftLabel: 'rgba(255,255,255,0.7)', ghostBg: '#e6e8fa', ghostBorder: '#2c3539',
        win: { bg: '#e6e8fa', border: '#555d50', text: '#2c3539', accent: '#7f8796' },
        alert: { bg: '#555d50', stroke: '#e6e8fa' },
    ...
    yankees: {
        ...
        palette: { bg: '#f0f2f5', border: '#b0b7bc', itemBg: '#ffffff', itemBorder: '#b0b7bc', toolBg: '#f0f2f5' },
        headerLeftText: '#ffffff', headerLeftLabel: 'rgba(255,255,255,0.8)', ghostBg: '#ffffff', ghostBorder: '#0c2340',
        win: { bg: '#ffffff', border: '#0c2340', text: '#0c2340', accent: '#e31837' },
        alert: { bg: '#0c2340', stroke: '#ffffff' },
    ...
    ketchup_mustard: {
        ...
        palette: { bg: '#fff8e1', border: '#ffe8a1', itemBg: '#ffffff', itemBorder: '#ffe8a1', toolBg: '#fff8e1' },
        headerLeftText: '#ffffff', headerLeftLabel: 'rgba(255,255,255,0.8)', ghostBg: '#ffffff', ghostBorder: '#d22b2b',
        win: { bg: '#ffffff', border: '#d22b2b', text: '#a01e1e', accent: '#ffc107' },
        alert: { bg: '#d22b2b', stroke: '#ffffff' },
        ctrlArea: { bg: '#fff8e1', border: '#ffe8a1' },
        burst: '#fff3cd', check: '#d22b2b'
    },
    forest: {
        ...
        palette: { bg: '#e9f5e9', border: '#c2e0c2', itemBg: '#ffffff', itemBorder: '#c2e0c2', toolBg: '#e9f5e9' },
        headerLeftText: '#ffffff', headerLeftLabel: 'rgba(255,255,255,0.7)', ghostBg: '#f2fcf2', ghostBorder: '#2e5a2c',
        win: { bg: '#f2fcf2', border: '#4a7c49', text: '#2e5a2c', accent: '#8b5a2b' },
        alert: { bg: '#2e5a2c', stroke: '#f2fcf2' },
        ctrlArea: { bg: '#e9f5e9', border: '#c2e0c2' },
        burst: '#dff0df', check: '#2e5a2c'
    },
    gold: {
        ...
        palette: { bg: '#2a2515', border: '#5c4a10', itemBg: '#1c190d', itemBorder: '#5c4a10', toolBg: '#2a2515' },
        headerLeftText: '#ffffff', headerLeftLabel: 'rgba(255,255,255,0.7)', ghostBg: '#1c190d', ghostBorder: '#ffd700',
        win: { bg: '#1c190d', border: '#ffd700', text: '#ffdf00', accent: '#daa520' },
        alert: { bg: '#b8860b', stroke: '#ffd700' },
    ...
    tupperware: {
        ...
        palette: { bg: '#e8ddbc', border: '#c9bb8e', itemBg: '#dfd3ae', itemBorder: '#c9bb8e', toolBg: '#e8ddbc' },
        headerLeftText: '#ffffff', headerLeftLabel: 'rgba(255,255,255,0.8)', ghostBg: '#dfd3ae', ghostBorder: '#cc5500',
        win: { bg: '#dfd3ae', border: '#5b7c2f', text: '#4d3826', accent: '#cc5500' },
        alert: { bg: '#cc5500', stroke: '#dfd3ae' },
    ...
    paddys_day: {
        ...
        palette: { bg: '#e8f5e9', border: '#a5d6a7', itemBg: '#ffffff', itemBorder: '#a5d6a7', toolBg: '#e8f5e9' },
        headerLeftText: '#ffffff', headerLeftLabel: 'rgba(255,255,255,0.8)', ghostBg: '#ffffff', ghostBorder: '#006400',
        win: { bg: '#ffffff', border: '#006400', text: '#1b5e20', accent: '#e65100' },
        alert: { bg: '#006400', stroke: '#ffffff' },
    ...
    usa: {
        ...
        palette: { bg: '#f0f4f8', border: '#b3c6d6', itemBg: '#ffffff', itemBorder: '#b3c6d6', toolBg: '#f0f4f8' },
        headerLeftText: '#ffffff', headerLeftLabel: 'rgba(255,255,255,0.8)', ghostBg: '#ffffff', ghostBorder: '#bf0a30',
        win: { bg: '#ffffff', border: '#002868', text: '#002868', accent: '#bf0a30' },
        alert: { bg: '#002868', stroke: '#ffffff' },
        ctrlArea: { bg: '#f0f4f8', border: '#b3c6d6' },
        burst: '#dbe4ec', check: '#002868'
    },
    kwanzaa: {
        ...
        palette: { bg: '#fff8e7', border: '#d7ccc8', itemBg: '#ffffff', itemBorder: '#d7ccc8', toolBg: '#fff8e7' },
        headerLeftText: '#ffffff', headerLeftLabel: 'rgba(255,255,255,0.8)', ghostBg: '#ffffff', ghostBorder: '#000000',
        win: { bg: '#ffffff', border: '#000000', text: '#000000', accent: '#4CAF50' },
        alert: { bg: '#D32F2F', stroke: '#ffffff' },
    ...
    cozy_cottage: {
        ...
        palette: { bg: '#fdf6e3', border: '#d7ccc8', itemBg: '#ffffff', itemBorder: '#d7ccc8', toolBg: '#fdf6e3' },
        headerLeftText: '#ffffff', headerLeftLabel: 'rgba(255,255,255,0.8)', ghostBg: '#ffffff', ghostBorder: '#8d6e63',
        win: { bg: '#ffffff', border: '#8fbc8f', text: '#5d4037', accent: '#d291bc' },
        alert: { bg: '#d291bc', stroke: '#ffffff' },
    ...
    patchwork: {
        ...
        palette: { bg: '#f4eedd', border: '#b5a8b3', itemBg: '#faf8f5', itemBorder: '#b5a8b3', toolBg: '#f4eedd' },
        headerLeftText: '#ffffff', headerLeftLabel: 'rgba(255,255,255,0.7)', ghostBg: '#faf8f5', ghostBorder: '#ab5a50',
        win: { bg: '#faf8f5', border: '#5c8397', text: '#4a3e49', accent: '#ab5a50' },
        alert: { bg: '#ab5a50', stroke: '#faf8f5' },
    ...
    canada: {
        ...
        palette: { bg: '#f8f9fa', border: '#cbd5e1', itemBg: '#ffffff', itemBorder: '#cbd5e1', toolBg: '#f8f9fa' },
        headerLeftText: '#ffffff', headerLeftLabel: 'rgba(255,255,255,0.8)', ghostBg: '#ffffff', ghostBorder: '#c8102e',
        win: { bg: '#ffffff', border: '#c8102e', text: '#222222', accent: '#c8102e' },
        alert: { bg: '#c8102e', stroke: '#ffffff' },
    ...
    sock_hop: {
        ...
        palette: { bg: '#e0ffff', border: '#aaaaaa', itemBg: '#ffffff', itemBorder: '#aaaaaa', toolBg: '#e0ffff' },
        headerLeftText: '#ffffff', headerLeftLabel: 'rgba(255,255,255,0.8)', ghostBg: '#ffffff', ghostBorder: '#ff69b4',
        win: { bg: '#ffffff', border: '#008b8b', text: '#ff1493', accent: '#ff69b4' },
        alert: { bg: '#ff69b4', stroke: '#ffffff' },
    ...
    ultra_modern: {
        ...
        palette: { bg: '#111111', border: '#444444', itemBg: '#1a1a1a', itemBorder: '#444444', toolBg: '#111111' },
        headerLeftText: '#00ffff', headerLeftLabel: 'rgba(0, 255, 255, 0.6)', ghostBg: '#1a1a1a', ghostBorder: '#bf00ff',
        win: { bg: '#1a1a1a', border: '#ffffff', text: '#00ffff', accent: '#bf00ff' },
        alert: { bg: '#222222', stroke: '#bf00ff' },
        ctrlArea: { bg: '#111111', border: '#444444' },
