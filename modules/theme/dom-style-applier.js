// Applies theme tokens as inline styles on specific DOM elements.
// Encapsulated here so the applyTheme facade stays lean and so these
// writes can be progressively replaced with CSS var() references as
// the HTML/CSS is updated.

export function applyDomStyles(APP, t) {
    ...
    ['resetBtn', 'undoBtn', 'whoaBtn', 'guideBtn', 'editResetGrid', 'editNewLevel', 'editMegaSolver',
     'editTrapSpotsBtn', 'editHelpBtn', 'editCopyMetrics', 'hintBtn', 'reviewHintBtn', 'reviewPublishedLevelsBtn'].forEach(id => {
