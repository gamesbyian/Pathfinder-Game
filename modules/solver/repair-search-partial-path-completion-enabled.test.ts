...
deepTest('searchCompletionFromPartialPath enabled rescues R02560 within the shared regression node budget', async () => {
    ...
    assert.ok(path, 'expected production-default searchCompletionFromPartialPath to solve within the shared node budget');
