...
import { retryTierEffectiveWorkStart, runWholeLadderRetryTier } from './stage-executors.js';
...
async function capturedExecutorWorkStart(cfg: AblationConfig | null, stageId: 'goal-attraction-disabled-retry' | 'connectivity-axis-prune-disabled-retry'): Promise<number> {
    const prep = {
        _cfg: cfg,
        _workMeter: { units: 80 },
