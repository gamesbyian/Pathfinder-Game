...
export const SOLVER_STAGE_IDS = Object.freeze([
    ...
    'late-repair-must-turn-biased-retry', 'guidance-goal-distance-retry', 'late-repair-multiseed-retry', 'portal-coarse-state-merge-dead-last-retry',
