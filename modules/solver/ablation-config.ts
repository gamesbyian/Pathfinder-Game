...
export const FEATURES: Record<string, string> = {
    ...
    STRATEGY_GOAL_ATTRACTION_DISABLED_RETRY_NODE_RESERVE: 'Production default-OFF; closed retained opt-in: reserve part of the main-search late slice for goal-attraction-disabled-retry stage. Current disposition: docs/solver-opt-in-experiment-ledger.md.',
    STRATEGY_GOAL_ATTRACTION_DISABLED_RETRY_FRESH_WORK_POOL: 'Production default-OFF; NEW, unvalidated opt-in landed 2026-09-02: gives the goal-attraction-disabled-retry pass a fresh work pool (sized off diversityBudgetFraction of the solve\'s own workBudget) instead of sharing the outer, already-depleting pool with every earlier tier. Motivated by reports/2026-09-02-goal-attraction-disabled-retry-work-pool-starvation.md, which found the shared pool independently starves 64% of otherwise-eligible attempts even with the sibling node reserve on. Current disposition: docs/solver-opt-in-experiment-ledger.md.',
...
export const OPT_IN_FEATURES = new Set([
    ...
    'STRATEGY_GOAL_ATTRACTION_DISABLED_RETRY_NODE_RESERVE',
