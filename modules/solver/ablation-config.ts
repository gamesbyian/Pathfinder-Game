...
export const FEATURES: Record<string, string> = {
    ...
    STRATEGY_MAIN_LOOP_LATE_RESERVE: 'Production default-ON: reserve a fixed main-search node slice for a late config suffix without reordering attempts (MAIN_SEARCH_LATE_RESERVE_FRACTION in orchestration.ts).',
