...
export const FEATURES: Record<string, string> = {
    ...
    STRATEGY_NEAR_HAMILTONIAN_INTERSECTION_HARVEST_MECHANIC_BUCKET_EXPOSURE: 'Production default-OFF, research-only: adds beam:intersectionHarvest@beam5000 with mechanicBucketRetention to attempts.ts\'s near-Hamiltonian intersection-heavy routing rule, reserve-preserving placement (before the protected trailing-5 window, not appended after it). Motivated by CID-0027 (data/stress/capability-invention-demand.json): R00118 (requiredIntersections=6, non-portal, near-Hamiltonian path coverage) is solved by exactly this action in EW1 isolation, but production only offers the plain-retention sibling at the same score/width via this rule. The originating design report misattributed R00118 to a different (catch-all) rule; getAttemptConfigs confirms this is the actual matched rule. See reports/2026-09-25-capability-invention-demand-ew1-routing-exposure-test-design-001.md; not yet dispatched.',
    STRATEGY_VERY_HIGH_INT_WIDTH2000_HARVEST_KNOT_MUSTCROSS_EXPOSURE: 'Production default-OFF, research-only: adds beam:harvestThenFinish/knotBuilder/mustCrossFirst@beam2000 to the very-high-requiredIntersections non-portal routing rule (attempts.ts), reserve-preserving placement (before the protected trailing pair, not appended after it). Motivated by CID-0028 (data/stress/capability-invention-demand.json): R02696 (requiredIntersections=12, non-portal, singleton-T1-supported) is solved by all three of these score functions in EW1 isolation, but production offers none of them at any width for this feature profile. See reports/2026-09-25-capability-invention-demand-ew1-routing-exposure-test-design-001.md for the located branch and design; not yet dispatched.',
