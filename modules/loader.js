export function installLoader(APP) {
    APP.Loader = (() => {
        const state = {
            progress: 0,
            hasLoaded: false,
            ...
            state.initPromise = new Promise((resolve) => {
                ...
                loadThemes
                    ...
                    .then(() => {
                        ...
                        if (!Array.isArray(APP.Data.getLevels()) || APP.Data.getLevels().length === 0) {
                            done('failed');
                            return;
                        }
                        ...
                        if (APP.Core.DEV) console.log('Levels loaded:', APP.Data.getLevels().length);
                        done('ready');
                    })
                    .catch(err => {
