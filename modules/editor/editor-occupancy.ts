...
export const LANDMARK_TOOL_DEFS: Record<string, { objectType: string, role: string, turn?: string }> = {
    ...
    fountainCcw:   { objectType: 'fountain', role: 'adjacentTurn', turn: 'ccw' },
    fountainCw:    { objectType: 'fountain', role: 'adjacentTurn', turn: 'cw' },
    lamppost:      { objectType: 'lamppost', role: 'adjacentTurn' },
    lamppostCcw:   { objectType: 'lamppost', role: 'adjacentTurn', turn: 'ccw' },
    lamppostCw:    { objectType: 'lamppost', role: 'adjacentTurn', turn: 'cw' },
    library:       { objectType: 'library',  role: 'mustTurn' },
    libraryCcw:    { objectType: 'library',  role: 'mustTurn', turn: 'ccw' },
    libraryCw:     { objectType: 'library',  role: 'mustTurn', turn: 'cw' },
