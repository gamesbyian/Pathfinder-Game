...
Suggest 6 complementary hex colors in #RRGGBB format.`;
    ...
    function applyTheme(name) {
        ...
        const t = themes[name];
            ...
            document.body.style.backgroundColor = t.bodyBg; APP.Renderer.getCanvas().style.backgroundColor = t.canvasBg; APP.UI.getEl('canvasContainer').style.backgroundColor = t.canvasBg;
            APP.UI.getEl('mainGamePane').style.borderColor = t.layout.mainBorder;
            APP.UI.getEl('headerLeft').style.backgroundColor = t.canvasBg;
            APP.UI.getEl('headerLeft').style.borderRightColor = t.layout.headerLeftBorder;
            APP.UI.getEl('headerMiddle').style.backgroundColor = t.headerLeft;
            APP.UI.getEl('headerRight').style.backgroundColor = t.headerRight;
            APP.UI.getEl('headerBar').style.borderColor = t.grid;
            APP.UI.getEl('levelTitle').style.color = t.text.headerMain;
            APP.UI.getEl('levelLabelText').style.color = t.text.headerSub;
            const ghost = APP.UI.getEl('dragGhost'); ghost.style.backgroundColor = t.ghostBg; ghost.style.borderColor = t.ghostBorder; const pal = APP.UI.getEl('editorPalette'); pal.style.backgroundColor = t.palette.bg; pal.style.borderColor = t.palette.border; Array.from(document.querySelectorAll('.palette-item')).forEach(item => { item.style.backgroundColor = t.palette.itemBg; item.style.borderColor = t.palette.itemBorder; }); APP.UI.getEl('editCopyMetrics').style.backgroundColor = t.headerLeft; APP.UI.getEl('editCopyMetrics').style.borderColor = t.palette.itemBorder; const pc = APP.UI.getEl('playControls'); pc.style.backgroundColor = t.controls; pc.style.borderColor = t.grid; APP.UI.getEl('undoBtn').style.backgroundColor = t.btns.undo; APP.UI.getEl('resetBtn').style.backgroundColor = t.btns.reset; APP.UI.getEl('guideBtn').style.backgroundColor = t.btns.guide; APP.UI.getEl('whoaBtn').style.backgroundColor = t.btns.whoa;
            ...
            APP.UI.getEl('openThemeModalBtn').style.borderColor = t.shell.btnBorder;
                        APP.UI.getEl('orientationToggleBtn').style.backgroundColor = t.btns.orient || t.btns.modeToggle || t.headerRight || '#1e293b';
            APP.UI.getEl('orientationToggleBtn').style.color = t.text.shellBtn || t.text.megaPrimary || '#ffffff';
            APP.UI.getEl('orientationToggleBtn').style.borderColor = t.grid;

            APP.UI.getEl('hintBtn').style.backgroundColor = t.btns.hint || t.btns.guide || t.headerRight || '#cf6b17'; ['resetBtn','undoBtn','whoaBtn','guideBtn','modeToggleBtn','editResetGrid','editNewLevel','editMegaSolver','editTrapSpotsBtn','editHelpBtn','editModeToggleBtn','editCopyMetrics','hintBtn'].forEach(id=>{const el=APP.UI.getEl(id); if(el) el.style.color=t.text.actionBtn;}); APP.UI.getEl('editResetGrid').style.backgroundColor = t.btns.editClear || t.btns.reset || '#dc2626'; APP.UI.getEl('editNewLevel').style.backgroundColor = t.btns.editNew || t.btns.saved || '#0a8a65'; APP.UI.getEl('editHelpBtn').style.backgroundColor = t.btns.guide; APP.UI.getEl('editMegaSolver').style.backgroundColor = t.btns.solve || t.headerRight || '#c026d3'; APP.UI.getEl('editTrapSpotsBtn').style.backgroundColor = t.btns.editBombs || t.colors.goal || '#ef4444'; APP.UI.getEl('modeToggleBtn').style.backgroundColor = t.btns.modeToggle || t.headerRight || '#1e293b'; APP.UI.getEl('editModeToggleBtn').style.backgroundColor = t.btns.modeToggle || t.headerRight || '#1e293b'; const muteBtn = APP.UI.getEl('muteBtn'); muteBtn.style.backgroundColor = t.shell.muteBg; muteBtn.style.color = t.shell.muteText; muteBtn.style.borderColor = t.shell.muteBorder; APP.UI.getEl('muteIcon').style.color = t.shell.muteText; APP.UI.getEl('muteSlash').style.color = t.shell.muteText; APP.UI.getEl('devCopyBtn').style.backgroundColor = t.btns.copy; APP.UI.getEl('editCopyBtn').style.backgroundColor = t.btns.copy; APP.UI.getEl('devGenBtn').style.backgroundColor = t.btns.gen; APP.UI.getEl('editGenBtn').style.backgroundColor = t.btns.gen; APP.UI.getEl('devCopyBtn').style.color = t.text.utilityBtn; APP.UI.getEl('editCopyBtn').style.color = t.text.utilityBtn; APP.UI.getEl('devGenBtn').style.color = t.text.utilityBtnGen; APP.UI.getEl('editGenBtn').style.color = t.text.utilityBtnGen; APP.UI.getEl('exportLabel').style.color = t.text.metric; Array.from(document.querySelectorAll('.metric-label')).forEach(el => el.style.color = t.text.metric); APP.UI.getEl('solutionOutput').style.backgroundColor = t.output?.bg || '#0f172a'; APP.UI.getEl('solutionOutput').style.color = t.text.output; APP.UI.getEl('solutionOutput').style.borderColor = t.modal.border; APP.UI.getEl('winSolutionOutput').style.backgroundColor = t.output?.bg || '#0f172a'; APP.UI.getEl('winSolutionOutput').style.color = t.text.output; APP.UI.getEl('winSolutionOutput').style.borderColor = t.modal.border; APP.UI.getEl('gridSizeMinusBtn').style.backgroundColor = t.btns.copy; APP.UI.getEl('gridSizeMinusBtn').style.color = t.btns.muteIcon; APP.UI.getEl('gridSizeMinusBtn').style.borderColor = t.palette.itemBorder; APP.UI.getEl('gridSizePlusBtn').style.backgroundColor = t.btns.copy; APP.UI.getEl('gridSizePlusBtn').style.color = t.btns.muteIcon; APP.UI.getEl('gridSizePlusBtn').style.borderColor = t.palette.itemBorder; APP.UI.getEl('gridRotateBtn').style.backgroundColor = t.btns.copy; APP.UI.getEl('gridRotateBtn').style.color = t.btns.muteIcon; APP.UI.getEl('gridRotateBtn').style.borderColor = t.palette.itemBorder; APP.UI.getEl('gridMirrorBtn').style.backgroundColor = t.btns.copy; APP.UI.getEl('gridMirrorBtn').style.color = t.btns.muteIcon; APP.UI.getEl('gridMirrorBtn').style.borderColor = t.palette.itemBorder; APP.UI.getEl('gridSizeLabel').style.color = t.btns.muteIcon;
            const gArea = APP.UI.getEl('gridControlArea'); if(gArea) { gArea.style.backgroundColor = t.ctrlArea?.bg || '#f8fafc'; gArea.style.borderColor = t.ctrlArea?.border || '#cbd5e1'; }
